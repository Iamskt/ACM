/**
 * bootstrap-toggle.js v1.0 http://github.com/Nijikokun/bootstrap-toggle/ --
 * http://twitter.com/nijikokun Copyright 2012 Nijiko Yonskai, Goodybag Inc --
...
!function($) {
	...
	var Toggle = function(element, options) {
		...
		if (this.options.text.enabled)
			this.$element.attr('data-enabled', this.options.text.enabled)
		if (this.options.text.disabled)
			this.$element.attr('data-disabled', this.options.text.disabled)
