 ...
 * http://www.vinterwebb.se/ SWFUpload is (c) 2006-2007 Lars Huring, Olov Nilzén
 * and Mammon Media and is released under the MIT License:
 * http://www.opensource.org/licenses/mit-license.php SWFUpload 2 is (c)
 * 2007-2008 Jake Roberts and is released under the MIT License:
...
SWFUpload.prototype.initSettings = function() {
	this.ensureDefault = function(c, d) {
		this.settings[c] = (this.settings[c] == undefined)
				? d
				: this.settings[c];
	};
		...
		init : function(d, e) {
			return this.each(function() {
				...
				if (h) {
					...
					f.html('<span class="uploadify-button-text">'
		...
		cancel : function(d, f) {
			...
			this.each(function() {
				...
				if (e[0]) {
					if (e[0] == "*") {
						...
						c("#" + j.queueID).find(".uploadify-queue-item").each(
								function() {
									...
									c(this).find(".data").removeClass("data")
											.html(" - Cancelled");
									c(this).find(".uploadify-progress-bar")
											.remove();
						...
						for (var m = 0; m < e.length; m++) {
							i.cancelUpload(e[m]);
							c("#" + e[m]).find(".data").removeClass("data")
									.html(" - Cancelled");
							c("#" + e[m]).find(".uploadify-progress-bar")
									.remove();
					...
					var k = c("#" + j.queueID).find(".uploadify-queue-item")
							.get(0);
					$item = c(k);
			...
			this.each(function() {
				...
				if (d.length === 1) {
					...
					switch (e) {
						...
						case "buttonText" :
							c("#" + j.id + "-button")
									.find(".uploadify-button-text").html(g);
							break;
						case "width" :
