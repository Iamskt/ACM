...
!function($) {
	...
	Carousel.prototype = {
		...
		,
		to : function(pos) {
			var $active = this.$element.find('.active'), children = $active
		...
		slide : function(type, next) {
			var $active = this.$element.find('.active'), $next = next
					|| $active[type](), isCycling = this.interval, direction = type == 'next'
					? 'left'
	...
	$(function() {
				$('body').on('click.carousel.data-api', '[data-slide]',
						function(e) {
