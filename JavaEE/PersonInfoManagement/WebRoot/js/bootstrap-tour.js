...
/*
 * ============================================================ #
 * bootstrap-tour.js v0.1 # http://pushly.github.com/bootstrap-tour/ #
 * ============================================================== # Copyright
 * 2012 Push.ly # # Licensed under the Apache License, Version 2.0 (the
	...
	(function($, window) {
		...
		Tour = (function() {
			...
			Tour.prototype.showStep = function(i) {
				var endOnClick, step, _this = this;
				step = this.getStep(i);
				...
				if (step.path !== ""
						&& document.location.pathname !== step.path
						&& document.location.pathname.replace(/^.*[\\\/]/, '') !== step.path) {
			...
			Tour.prototype._showPopover = function(step, i) {
				...
				if (step.end) {
					...
					content += "<a href='#"
							+ step.next
							+ "' class='next'>Next &raquo;</a>          <a href='#' class='pull-right end'>End tour</a></p>";
				}
			...
			Tour.prototype._reposition = function(tip) {
				...
				offsetBottom = $(document).outerHeight() - tipOffset.top
						- $(tip).outerHeight();
				if (offsetBottom < 0) {
					tipOffset.top = tipOffset.top + offsetBottom;
				}
				offsetRight = $(document).outerWidth() - tipOffset.left
						- $(tip).outerWidth();
				if (offsetRight < 0) {
			...
			Tour.prototype._scrollIntoView = function(tip) {
				...
				if (!(tipRect.top > 0 && tipRect.bottom < $(window).height()
						&& tipRect.left > 0 && tipRect.right < $(window)
						.width())) {
