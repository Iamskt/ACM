...
public class SubjectDAO extends BaseHibernateDAO {
	...
	public List findByExample(Subject instance) {
		...
		try {
			List results = getSession().createCriteria("org.njust.bean.Subject")
	...
	public List findBySubjection(Object subjection) {
		return findByProperty(SUBJECTION, subjection);
	}
