...
public class CollegeDAO extends BaseHibernateDAO {
	...
	public College findById(java.lang.Integer id) {
		...
		try {
			College instance = (College) getSession().get(
					"org.njust.bean.College", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(College instance) {
		...
		try {
			List results = getSession().createCriteria("org.njust.bean.College")
